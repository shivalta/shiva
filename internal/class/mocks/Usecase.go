...
func (_m *Usecase) Create(_a0 class.Domain) (class.Domain, error) {
	ret := _m.Called(_a0)
...
func (_m *Usecase) GetAll(search string, key string) ([]class.Domain, error) {
...
func (_m *Usecase) GetById(id uint) (class.Domain, error) {
	ret := _m.Called(id)
...
func (_m *Usecase) Update(_a0 class.Domain) (class.Domain, error) {
	ret := _m.Called(_a0)
